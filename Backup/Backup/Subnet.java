...
{
Scanner sc = new Scanner(System.in);  // allow user to take input form console 
...
bip += split_bip[i];  // appendZeros=method returns a string representation of the integer argument as an unsigned integer in base 2.
}
